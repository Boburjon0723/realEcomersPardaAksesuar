...
export default function StatsCards({ t, statusStats, totalSumma, filteredOrdersCount }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5 mb-8">
      {/* Visible Count */}
      <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-5 sm:p-6 rounded-2xl shadow-lg shadow-blue-200 hover:scale-[1.02] transition-all cursor-default">
